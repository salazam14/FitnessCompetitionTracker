 ...
 * This program provides a registration interface for a Fitness Tracker application. It allows new users
 * to register by entering their name, username, and password. The interface uses a background image to enhance
 * the aesthetic appeal and provides a straightforward, user-friendly form for entering user details.
 * 
